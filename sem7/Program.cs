// Task 1. Задать двумерный массив размером m*n, заполненный случайными числами
...
// int[,] myArray = Create2DSumArray(rows, columns);
// Print2DArray(myArray); 